...
const (
	regexIPv4 = `(\b25[0-5]|\b2[0-4][0-9]|\b[01]?[0-9][0-9]?)(\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}`
...
func IP(ip string) bool {
	matchIPv4, _ := regexp.MatchString(regexIPv4, ip)
	matchIPv6, _ := regexp.MatchString(regexIPv6, ip)
